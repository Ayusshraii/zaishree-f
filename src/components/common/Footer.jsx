...
function FooterColumn({ title, links }) {
  return (
    <div>
      <h3 className="text-xs tracking-[0.2em] uppercase text-[#B76E79] font-medium mb-4">
        {title}
      </h3>
  ...
  return (
    <footer className="bg-[#FFFFFF] text-[#2E2E2E] font-sans ">
      ...
      {/* =========================
          TRUST STRIP
      ========================== */}
      <div className="bg-[#FAF7F4] border-b border-[#E8DDD3]">
        <div className="max-w-4xl mx-auto px-6 py-6 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {trustBadges.map(({ icon: Icon, label }) => (
            ...
            >
              <Icon className="w-5 h-5 text-[#B76E79] shrink-0" />

              <span className="text-xs text-[#2E2E2E]/70 leading-tight">
                {label}
              </span>
            </div>
          ))}
      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <h2 className="font-serif text-2xl tracking-wide mb-3 text-[#2E2E2E]">
              Zaishree
            </h2>

            <p className="text-sm text-[#2E2E2E]/65 leading-relaxed mb-6 max-w-xs">
            ...
            <form onSubmit={handleSubmit} className="max-w-xs">
              ...
              <label
                ...
                className="text-xs tracking-[0.2em] uppercase text-[#B76E79] font-medium block mb-2"
              >
                Join the list
              </label>

              <div className="flex border-b border-[#E8DDD3] focus-within:border-[#B76E79] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-start gap-2.5 text-sm text-[#2E2E2E]/75">
                <FiMapPin className="w-4 h-4 text-[#B76E79] mt-0.5 shrink-0" />
              ...
              <li className="flex items-center gap-2.5 text-sm text-[#2E2E2E]/75">
                <FiPhone className="w-4 h-4 text-[#B76E79] shrink-0" />
      ...
      <div className="flex items-center justify-center gap-4 px-6 pb-8">
        ...
        <span className="h-px w-16 sm:w-32 bg-[#E8DDD3]" />
      ...
      {/* =========================
          BOTTOM BAR
      ========================== */}
      <div className="border-t border-[#E8DDD3] bg-[#FAF7F4]">
